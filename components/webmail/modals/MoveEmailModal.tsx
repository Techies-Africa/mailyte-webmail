      ...
      <div className="bg-card rounded-lg max-w-md w-full p-6 shadow-xl">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            disabled={!selected}
            className="px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 inline-flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            <FolderInput size={16} />
            Move
          </button>
